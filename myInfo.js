export default {
  ...
  experiences: [
    ...
    },
    {
      ...
      description: 'Developed an AWS job cost-tracking dashboard, reducing waste and saving an estimated $20,000+ per year. Implemented real-time cost monitoring and alerting for cloud job tracking, improving operational efficiency.',
      technologies: ['Python', 'React', 'Svelte', 'Express', 'PostgreSQL', 'AWS', 'BitBucket', 'Jira'],
    },
    {
      startDate: '2022',
      endDate: '2023',
      ...
      companySite: 'https://www.hackreactor.com/online-coding-bootcamp/intermediate-coding-bootcamp/',
      description: '12-week software engineering immersive program with 1000+ hours of coding. Full-Stack development with JavaScript, React, Node Express, PostgreSQL, MongoDB, MySQL, and more in an AGILE environment.',
    ...
    },
    {
      ...
      description: 'Designed and developed custom WordPress websites, ensuring modern UI/UX and performance optimization. Collaborated with clients to define requirements, delivering high-satisfaction from start to finish.',
      technologies: ['Javascript', 'Wordpress', 'Elementor', 'HTML', 'CSS'],
    },
  ],
};
